...
class LinkedInOAuth {
  ...
  public $host = "http://api.linkedin.com/v1/";
  /* Set timeout default. */
  public $timeout = 30;
  /* Set connect timeout. */
  ...
  function authenticateURL() { return 'https://www.linkedin.com/uas/oauth/authenticate'; }
  function authorizeURL()    { return 'https://www.linkedin.com/uas/oauth/authorize'; }
