...
log_error(__FILE__ . " start");//TIMING
define('DL_BASESCRIPT',substr($_SERVER['SCRIPT_FILENAME'],0,strrpos($_SERVER['SCRIPT_FILENAME'],'/')));
require_once(DL_BASESCRIPT . '/lib/lib.php');
$now_time = microtime(true);//TIMING
log_error(__FILE__ . " loaded lib.php in " . ($now_time - $start_time));//TIMING
...
log_error(__FILE__ . " query in " . ($now2_time - $now_time));//TIMING
...
$now2_time = microtime(true);//TIMING
log_error(__FILE__ . " total time " . ($now2_time - $start_time));//TIMING
?>